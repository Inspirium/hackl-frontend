    ...
    <div class="activity x-container">
      <div class="activity__results">
        <div class="activity__header m-b-10">
          <nuxt-link :to="localePath('/liga')" class="fw600"
            >{{ $t('aktivneLige') }}
          ...
          <b-table-column v-slot="props" cell-class="active list__image-col" field="first_name">
            ...
            >
              <div class="list__content">
                ...
                <h3 v-if="props.row.type === 'private'" class="fw600 has-text-lightblue is-size-65">
                  {{ $t('Privatna liga') }}
                </h3>
                <h3 v-else class="fw600 has-text-lightblue is-size-65">
                  {{ $t('Otvorena liga') }}
                </h3>
              </div>
        ...
        <div v-if="!liga.length" class="empty__box">
          ...
          <div class="fw600 is-size-54 m-t-10 m-b-15 has-text-centered">{{ $t('pokreniTeniskuLigu') }}</div>
