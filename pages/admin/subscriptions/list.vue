<template>
  <div class="member p-b-200">
    <PageHeader :title="$t('Nalozi članarina')" />
      ...
      <div class="home-menu-middle">
        <div :class="[activeMainTab === 0 ? 'active-menu-item' : 'menu-item']" @click="goToTab(0)">
          <div class="has-text-black80 flex flex__column align__centar__y">
            <b-icon class="m-b-5" pack="fal" icon="ban" type="is-danger"> </b-icon>
            <div class="is-size-6 fw600">{{ $t('Neplaćeno') }}</div>
          </div>
        </div>
        <div :class="[activeMainTab === 1 ? 'active-menu-item' : 'menu-item']" @click="goToTab(1)">
          <div class="has-text-black80 flex flex__column align__centar__y">
            <b-icon class="m-b-5" pack="fal" icon="check" type="is-success"> </b-icon>
            <div class="is-size-6 fw600 has-text-centered">{{ $t('Plaćeno') }}</div>
          </div>
        </div>
        <div :class="[activeMainTab === 2 ? 'active-menu-item' : 'menu-item']" @click="goToTab(2)">
          <div class="has-text-black80 flex flex__column align__centar__y">
            <b-icon class="m-b-5" pack="fal" icon="circle-exclamation" type="is-black50"> </b-icon>
            <div class="is-size-6 fw600 has-text-centered">{{ $t('Upozorenja') }}</div>
          </div>
        </div>
      </div>
    </div>
