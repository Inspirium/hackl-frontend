<template>
  <div ref="top" class="">
    <b-tabs v-model="activeTab" class="hide-only-one" position="is-centered">
      <b-tab-item>
        <hero>
        ...
        <div v-if="!isReservationModal" class="buttons is-fixed is-primary has-text-white m-t-20">
...
export default {
  ...
  async fetch() {
    ...
    this.$buefy.toast.open({
      message:
        'Odabrate termine koji vam odgovaraju te ih predložite suigračima. Klikom na termin on će automatski biti rezerviran',
      type: 'is-primary',
      duration: 6000,
    })
  },
