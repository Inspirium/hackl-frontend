<template>
  <div>
    ...
    <div v-touch:swipe="swipeHandler" class="activity x-container results schedule">
      ...
      <div class="date-picker m-t-0">
        <div class="m-b-10">
          <div class="has-text-centered fw600 m-t-5 is-size-4">{{ $t('Popis današnjih mečeva') }}</div>
        </div>
      </div>
      <div v-if="total" class="m-t--20 m-b-10">
      ...
      <div class="relative p-b-200">
        ...
        <section v-if="!filteredList.length && !loading" class="p-l-15 p-r-15 m-t-20">
          <div class="content has-text-grey has-text-centered">
            ...
            <p class="has-text-centered fw600 m-t-5 is-size-5">
              {{ $t('Za live prijenos meča susret mora imati rezervaciju u aplikaciji') }}
            </p>
          </div>
        </section>
      </div>
...
import scheduleBoxAdvance from '~/components/ScheduleBox'
